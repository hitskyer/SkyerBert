...
parser.add_argument('--model', type=str, default='SkyerERNIEDPCNN',
                    help = 'choose a model SkyerBert, SkyerBertCNN, SkyerBertRNN, SkyerBertRCNN, SkyerBertDPCNN, SkyerERNIE,SkyerERNIEDPCNN')
